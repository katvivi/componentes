import 'package:componentes_galeria_flutter/app_bar.dart';
import 'package:componentes_galeria_flutter/menu.dart';
import 'package:flutter/material.dart';

import 'banner.dart';
import 'barra_app_inferior.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/banner':(context) => const BannerWidget(),
        '/barraInferior':(context) => const BottomAppBarDemo(),
